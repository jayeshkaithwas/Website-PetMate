...
<html lang="en">
<head>
	<title>PetMate - Network, Community and Event Theme</title>

	<!-- Meta Tags -->
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<meta name="description" content="PetMate">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				...
				<div class="nav mt-3 mt-lg-0 flex-nowrap align-items-center px-4 px-lg-0">
					<div class="nav-item w-100">
						<form class="rounded position-relative" style="top: 7px;">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3" aria-labelledby="profileDropdown">
						...
						<li class="px-3">
							<div class="d-flex align-items-center position-relative">
								...
								<div>
									<a class="h6 stretched-link" href="#"><?php echo $username?></a>
									<p class="small m-0">breed</p>
								</div>
							</div>
						...
						<form method="POST" action="SignIn.php" class="register-form" id="login-form">
						     <li>
						   	<a class="dropdown-item bg-danger-soft-hover" href="?logout=1">
				...
				<nav class="navbar navbar-expand-lg mx-0"> 
					<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSideNavbar">
						...
						<div class="offcanvas-body d-block px-2 px-lg-0">
							...
							<div class="card overflow-hidden">
								...
								<div class="h-50px" style="background-image:url(assets/images/bg/01.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
									...
									<div class="card-body pt-0">
										...
										<!-- Info -->
										<h5 class="mb-0"> <a href="#!"><?php echo $username?></a> </h5>
							...
							<!-- Helper link END -->
							<!-- Copyright -->
							<p class="small text-center mt-1">©2023 <a class="text-body" target="_blank" href="https://www.webestica.com/"> PetMate </a></p>
						</div>
					</div>
				</nav>
				<!-- Navbar END-->
							...
							<div class="card-body">
								...
								<div class="hstack gap-2 mb-3">
									...
									<div class="overflow-hidden">
										<a class="h6 mb-0" href="#!">Buddy </a>
										<p class="mb-0 small text-truncate">French Bulldog</p>
									</div>
									<!-- Button -->
								...
								<!-- Connection item START -->
									<div class="hstack gap-2 mb-3">
										...
										<!-- Title -->
										<div class="overflow-hidden">
											<a class="h6 mb-0" href="#!">Duke </a>
											<p class="mb-0 small text-truncate">Basenji</p>
										</div>
										<!-- Button -->
										<a class="btn btn-primary-soft rounded-circle icon-md ms-auto" href="#"><i class="fa-solid fa-plus"> </i></a>
								</div>
								...
								<div class="hstack gap-2 mb-3">
									...
									<!-- Title -->
									<div class="overflow-hidden">
										<a class="h6 mb-0" href="#!">Coco </a>
										<p class="mb-0 small text-truncate">Black Russian Terrier</p>
									</div>
									<!-- Button -->
								...
								<div class="hstack gap-2 mb-3">
									...
									<!-- Title -->
									<div class="overflow-hidden">
										<a class="h6 mb-0" href="#!">lori </a>
										<p class="mb-0 small text-truncate">Samoyed</p>
									</div>
									<!-- Button -->
									<a class="btn btn-primary-soft rounded-circle icon-md ms-auto" href="#"><i class="fa-solid fa-plus"> </i></a>
								</div>
								...
								<div class="hstack gap-2 mb-3">
									...
									<!-- Title -->
									<div class="overflow-hidden">
										<a class="h6 mb-0" href="#!">Max </a>
										<p class="mb-0 small text-truncate">Dobermann</p>
									</div>
									<!-- Button -->
									<a class="btn btn-primary-soft rounded-circle icon-md ms-auto" href="#"><i class="fa-solid fa-plus"> </i></a>
								</div>
					...
					<div class="col-sm-6 col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								<!-- News item -->
								<div class="mb-3">
									<h6 class="mb-0"><a href="blog-details.html">Wellness in Every Bark: Empowering Dog Health Through Informed Solutions</a></h6>
									<small>2hr</small>
								</div>
								<!-- News item -->
								<div class="mb-3">
									<h6 class="mb-0"><a href="blog-details.html">Discovering the Best Feeding Method for Your Dog</a></h6>
									<small>3hr</small>
								</div>
								<!-- News item -->
								<div class="mb-3">
									<h6 class="mb-0"><a href="blog-details.html">How Online Pet Pharmacies Bring Vet-Approved Medications to Your Doorstep</a></h6>
									<small>4hr</small>
								</div>
								<!-- News item -->
								<div class="mb-3">
									<h6 class="mb-0"><a href="blog-details.html">Things You Need to Know About Dog Harnesses</a></h6>
									<small>6hr</small>
								</div>
								<!-- Load more comments -->
...
<!-- Mirrored from social.webestica.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Aug 2023 16:22:34 GMT -->
</html>
